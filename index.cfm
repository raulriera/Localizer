...
<h2>Methods Added</h2>
<p>Here is a list of the methods that are added by this plugin.</p>

<ul>
	<li>localize</li>
	<li>l</li>
	<li>getLocaleCode</li>
	<li>distanceOfTimeInWords (overwritten)</li>
	<li>timeAgoInWords (overwritten)</li>
	<li>timeUntilInWords (overwritten)</li>
</ul>
...
<ul>
	...
	<li>When you execute the code, the plugin will fill a "repository.cfm" file inside the "/plugins/localizer/locale" folder with the executed code</li>
